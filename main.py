...
customer_2 = Customer(ingredients[random.randint(0, num_food())], player, Vec2d(CUST2_POS))
customer_3 = Customer(ingredients[random.randint(0, num_food())], player, Vec2d(CUST3_POS))
customer_4 = Customer(ingredients[random.randint(0, num_food())], player, Vec2d(CUST4_POS))
customer_5 = Customer(ingredients[random.randint(0, num_food())], player, Vec2d(CUST5_POS))
...
while running:
    ...
    if random.randint(0, 1000) > 997:
        if customer_1 not in entities:
            customer_1 = Customer(ingredients[random.randint(0, 5)], player, Vec2d(CUST1_POS))
            entities.append(customer_1)
        elif customer_2 not in entities:
            customer_2 = Customer(ingredients[random.randint(0, 5)], player, Vec2d(CUST2_POS))
            entities.append(customer_2)
        elif customer_3 not in entities:
            customer_3 = Customer(ingredients[random.randint(0, 5)], player, Vec2d(CUST3_POS))
            entities.append(customer_3)
        elif customer_4 not in entities:
            customer_4 = Customer(ingredients[random.randint(0, 5)], player, Vec2d(CUST4_POS))
            entities.append(customer_4)
        elif customer_5 not in entities:
            customer_5 = Customer(ingredients[random.randint(0, 5)], player, Vec2d(CUST5_POS))
